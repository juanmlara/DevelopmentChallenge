...
namespace DevelopmentChallenge.Data.Tests
{
    ...
    public class DataTests
    {
        ...
        {
            var cuadrados = new List<FormaGeometrica> { new FormaGeometrica(FormaGeometrica.Trapecio, 4, 3, 8) };

            var resumen = FormaGeometrica.Imprimir(cuadrados, FormaGeometrica.Castellano);

            Assert.AreEqual("<h1>Reporte de Formas</h1>1 Trapecio | Area 18 | Perimetro 20 <br/>TOTAL:<br/>1 formas Perimetro 20 Area 18", resumen);
        }
        ...
        public void TestResumenListaConMasTrapecios()
        {
            ...
            {
                new FormaGeometrica(FormaGeometrica.Trapecio, 4, 3, 8),
                new FormaGeometrica(FormaGeometrica.Trapecio, 4, 3, 8),
                new FormaGeometrica(FormaGeometrica.Trapecio, 4, 3, 8)
            };
            ...
            Assert.AreEqual("<h1>Shapes report</h1>3 Trapezoids | Area 54 | Perimeter 60 <br/>TOTAL:<br/>3 shapes Perimeter 60 Area 54", resumen);
        }
    }
}
